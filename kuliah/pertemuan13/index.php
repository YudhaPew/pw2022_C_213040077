...
<html lang="en">
  ...
  <body>
<div class="container">
    <a href="index.php" style="text-decoration: none;" ><h1>Daftar Mahasiswa</h1></a>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $mhs['jurusan']; ?></td>
      <td>
          <a href="ubah.php?id=<?= $mhs ["id"]?>" class="btn badge bg-warning" onclick="return confirm('yang bener?');">Ubah</a>
          <a href="hapus.php?id=<?= $mhs ["id"]?>" class="btn badge bg-danger" onclick="return confirm('yang bener?');">Hapus</a>
