  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand">
        <img src="../tubes/img/logoshop-removebg-preview.png" alt="" width="67" height="36" class="d-inline-block">
        SHO<strong>PEW</strong>
      </a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarNav">
        <form method="get" style="padding-left:30%; width:65%; ">
          <div class="input-group">
            <input type="text" class="form-control" name="keyword" placeholder="Cari barang..." autocomplete="off">
        ...
        <div class="card text-center">
          <?php foreach ($product as $pro) : ?>
            ...
            <div class="card-body">
              ...
              <a href="beli.php?id=<?= $pro["product_id"]; ?>" class="btn btn-primary d-grid">Beli</a>
            <?php endforeach; ?>
            </div>
        </div>
      </div>
